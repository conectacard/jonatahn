const CONFIG = {
    youtubeUrl: "https://www.youtube.com/watch?v=8RiYvJXPTyA",
    ...
    get textos() {
        ...
        return {
            cat2: { 
                ...
                c: tObj.cat2_c || "La grandeza en la cancha es fruto de una disciplina inquebrantable y un esfuerzo constante. Con entrega total y un compromiso absoluto en cada partido, ha demostrado que el éxito combina talento y perseverancia, inspirando a otros a perseguir sus sueños con el corazón." 
            },
            cat3: { 
                t: tObj.cat3_t || "GRANDES MOMENTOS", 
                c: tObj.cat3_c || "Competir en los escenarios más exigentes del fútbol internacional significa llevar el orgullo de México y de sus raíces al máximo nivel. Cada partido es el resultado de una disciplina inquebrantable y el honor de representar con pasión, entrega y autenticidad en la cancha." 
            }
        };
    }
};
...
function renderGallery(cat) {
    ...
    if (cat === 'cat3') {
        ...
        videoContainer.innerHTML = `
            ...
            <a href="https://www.youtube.com/shorts/XNb8j4U0lyo" target="_blank" style="display: block; width: 100%; box-sizing: border-box; background: #000; color: #fff; padding: 12px 20px; border-radius: 8px; text-decoration: none; font-weight: 800; font-size: 0.85rem; text-align: center; border: 1px solid var(--brand-accent);">${tObj.btn_tributo_tri || 'Gol de Jonathan'}</a>
            <a href="https://www.youtube.com/shorts/JZElDLDPVdo" target="_blank" style="display: block; width: 100%; box-sizing: border-box; background: #000; color: #fff; padding: 12px 20px; border-radius: 8px; text-decoration: none; font-weight: 800; font-size: 0.85rem; text-align: center; border: 1px solid var(--brand-accent);">${tObj.btn_junto_mar || 'Entrevista con el Albacete'}</a>
            <a href="https://www.youtube.com/shorts/K4clSguz5bI" target="_blank" style="display: block; width: 100%; box-sizing: border-box; background: #000; color: #fff; padding: 12px 20px; border-radius: 8px; text-decoration: none; font-weight: 800; font-size: 0.85rem; text-align: center; border: 1px solid var(--brand-accent);">${tObj.btn_con_gente || 'La joya escondida de México'}</a>
        `;
